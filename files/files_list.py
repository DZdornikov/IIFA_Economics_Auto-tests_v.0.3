...
class CalculationConstructorFilesList:
    ...
    # ВАЖНО!!!
    # Метаданные о мастеркнигах хранятся в формате tuple, так тесты работают быстрее, но если в МК всего одна
    # консолидация, то хранить данные нужно в формате list, иначе тесты упадут. Данная особенность диктуется
    # особенностями формата tuple.
    #
